...
public class ManagerFrame extends JFrame {
    ...
    public ManagerFrame(String master, String data) {
        ...
        scroll.putClientProperty("FlatLaf.style", "arc: 12; background: $Panel.background;");
        ...
        serviceField.putClientProperty("JTextField.placeholderText", "Nome Servizio (es. Google)");
        serviceField.putClientProperty("FlatLaf.style", "showClearButton: true;");

        JTextField passField = new JTextField();
        passField.putClientProperty("JTextField.placeholderText", "Password");
        passField.putClientProperty("FlatLaf.style", "showClearButton: true;");
        ...
        addBtn.putClientProperty("FlatLaf.style", "background: $AccentColor; foreground: #FFFFFF;");
        ...
        saveBtn.addActionListener(e -> {
            try {
                ...
                Storage.save(sb.toString(), this.master);
